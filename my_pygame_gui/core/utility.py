...
from my_pygame_gui.core.interfaces import IUIManagerInterface, IGUIFontInterface
from my_pygame_gui.core.gui_font_freetype import GUIFontFreetype
...
class PackageResource:
    ...
    def to_path(self) -> str:
        ...
        if self.package.find('pygame_gui') == 0:
            # This is default data from my_pygame_gui so relative to pygame_gui rather than app
