...
from my_pygame_gui._constants import UI_BUTTON_PRESSED, UI_SELECTION_LIST_DOUBLE_CLICKED_SELECTION
from my_pygame_gui._constants import UI_SELECTION_LIST_NEW_SELECTION, OldType
from my_pygame_gui._constants import UI_TEXT_ENTRY_FINISHED, UI_TEXT_ENTRY_CHANGED
from my_pygame_gui._constants import UI_CONFIRMATION_DIALOG_CONFIRMED, UI_FILE_DIALOG_PATH_PICKED

from my_pygame_gui.core.interfaces import IUIManagerInterface
from my_pygame_gui.elements import UIWindow, UIButton, UITextEntryLine, UISelectionList
from my_pygame_gui.windows.ui_confirmation_dialog import UIConfirmationDialog
...
class UIFileDialog(UIWindow):
    ...
    def _validate_file_or_dir_path(self, path_to_validate: Path) -> bool:
